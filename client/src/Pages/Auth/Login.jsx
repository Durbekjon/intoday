        ...
        <>
            <div className='reg w-full min-h-[100vh] flex justify-center items-center'>
                <div className='border-[1px] border-[#EFEBF6] max-w-[758px] min-h-[510px] rounded-[--CornerSmall] p-[51px_62px] bg-transparent '>
                    ...
                    <h1 className=' mb-[45.5px] text-[36px] font-[700] leading-[43.2px] text-[#FFF]'>Login your acount</h1>
                    <Form
                        name="basic"
                        labelCol={{
                            span: 24,
                    ...
                    >
                        ...
                        <Link to={"/register"} className='text-[21px] font-[700] leading-[25.2px] text-[#FFF] mt-[10px]'> Create acount? </Link>
                    </Form>
                </div>
            </div>
        </>
